...
class ConstantsAndUnits:
  ...
  def __init__(self, typeOfUnits = "SI", 
    ...
    self.xhi1        = self._xhi1_eV * self.eV
    self.m_p         = self._m_p_SI * self.kg	              # Ionization energy for singly ionized Helium
  ...
  def temperature_to_SI(self,T):
    return T / (self.K)
  def seconds_to_Gyr(self,s):
      return s*3.1710e-17

# Make a global constants 
const = ConstantsAndUnits("SI")
constRP = ConstantsAndUnits("ReducedPlanck")
constCos = ConstantsAndUnits("Cosmology")
constP = ConstantsAndUnits("Planck")